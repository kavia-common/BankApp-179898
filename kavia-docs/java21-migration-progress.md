...
| 03.01 | Code refactor to jakarta and Security 6 | Success | javax.persistence -> jakarta.persistence across entities; verified no javax.validation/servlet remains. Final sweep confirms no remaining javax.* in persistence, validation, or servlet packages anywhere in the codebase. |
